...
<body>
  ...
  <main class="main" id="main">
        ...
        <section class="section dashboard">
          <div class="col-12">
            <h5 class="title">Complaints from customers</h5>
                  <?php
                    ...
                    echo"
                        <thead>
                            <tr>
                              ...
                              <th scope='col'>Point of Purchase</th>
                              <th scope='col'>Date of Purchase</th>
                              <th scope='col'>Evidence of Payment</th>
                            </tr>
                        </thead>
                        <tbody>
                    ";
                      ...
                      while($row = mysqli_fetch_assoc($result)){
                          echo"
                              <tr>
                                  ...
                                  <td>".$row['point_of_pur']."</td>
                                  <td>".$row['date_of_pur']."</td>
                                  <td> <img src='evidence/".$row['evidence_of_pay']."' class='img-fluid'></td>
                              </tr>
                          ";
                      }
                    }
